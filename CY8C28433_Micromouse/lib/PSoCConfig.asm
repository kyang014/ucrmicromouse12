...
export LoadConfig_cy8c28433_micromouse
export _LoadConfig_cy8c28433_micromouse
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_cy8c28433_micromouse
	lcall	LoadConfigTBL_cy8c28433_micromouse_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration cy8c28433_micromouse
;
;    Load configuration registers for cy8c28433_micromouse.
...
;               CUR_PP
;
_LoadConfig_cy8c28433_micromouse:
 LoadConfig_cy8c28433_micromouse:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_cy8c28433_micromouse_Bank0
    mov     X, <LoadConfigTBL_cy8c28433_micromouse_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_cy8c28433_micromouse_Bank1
    mov     X, <LoadConfigTBL_cy8c28433_micromouse_Bank1
