...
CSRCS= adc.c main.c motion.c motor.c sched.c ui.c
LIBCSRCS=
STDCSRCS=
ASMSRCS=
...
STDASMSRCS=
OBJECT_SOURCES= adc.c main.c motion.c motor.c sched.c ui.c
FILLVALUE=0x30
LASTROM=0x3fff
LASTRAM=0x3ff
LAST_DATARAM=0x31f
...
LMM=1
SYS_INC_CONTENTS:=SYSTEM_STACK_PAGE:_equ_3 SYSTEM_STACK_BASE_ADDR:_equ_20h SYSTEM_LARGE_MEMORY_MODEL:_equ_1 SYSTEM_SMALL_MEMORY_MODEL:_equ_0 IMAGECRAFT:_equ_1 HITECH:_equ_2 TOOLCHAIN:_equ_IMAGECRAFT 
SYSTEM_TOOLS=1
CSFLOW=
