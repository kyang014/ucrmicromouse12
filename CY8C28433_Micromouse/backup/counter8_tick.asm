...
include "m8c.inc"
include "memory.inc"
include "Counter8_Tick.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Counter8_Tick_EnableInt
export _Counter8_Tick_EnableInt
export  Counter8_Tick_DisableInt
export _Counter8_Tick_DisableInt
export  Counter8_Tick_Start
export _Counter8_Tick_Start
export  Counter8_Tick_Stop
export _Counter8_Tick_Stop
export  Counter8_Tick_WritePeriod
export _Counter8_Tick_WritePeriod
export  Counter8_Tick_WriteCompareValue
export _Counter8_Tick_WriteCompareValue
export  Counter8_Tick_bReadCompareValue
export _Counter8_Tick_bReadCompareValue
export  Counter8_Tick_bReadCounter
export _Counter8_Tick_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bCounter8_Tick_ReadCompareValue  ; deprecated
export _bCounter8_Tick_ReadCompareValue  ; deprecated
export  bCounter8_Tick_ReadCounter       ; deprecated
export _bCounter8_Tick_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_Tick_EnableInt:
_Counter8_Tick_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_Tick_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_Tick_DisableInt:
_Counter8_Tick_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_Tick_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_Start
;
;  DESCRIPTION:
...
;
 Counter8_Tick_Start:
_Counter8_Tick_Start:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_Tick_Start_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_Stop
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_Tick_WritePeriod:
_Counter8_Tick_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_Tick_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_Tick_WriteCompareValue:
_Counter8_Tick_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_Tick_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_Tick_bReadCompareValue:
_Counter8_Tick_bReadCompareValue:
 bCounter8_Tick_ReadCompareValue:                ; this name deprecated
_bCounter8_Tick_ReadCompareValue:                ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Counter8_Tick_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_Tick_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 Counter8_Tick_bReadCounter:
_Counter8_Tick_bReadCounter:
 bCounter8_Tick_ReadCounter:                     ; this name deprecated
_bCounter8_Tick_ReadCounter:                     ; this name deprecated
   ...
   mov   A, reg[Counter8_Tick_COMPARE_REG]       ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[Counter8_Tick_CONTROL_REG]       ; Save CR0 (running or stopped state)
   push  A                                       ;
   Counter8_Tick_Stop_M                          ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[Counter8_Tick_INPUT_REG]         ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[Counter8_Tick_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[Counter8_Tick_COUNTER_REG]       ; DR2 <- DR0
   mov   A, reg[Counter8_Tick_COMPARE_REG]       ; Stash the Count on the stack
   ...
   mov   reg[Counter8_Tick_INPUT_REG], A         ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[Counter8_Tick_CONTROL_REG], A       ;     this function was first called
