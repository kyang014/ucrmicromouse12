...
include "m8c.inc"
include "memory.inc"
include "Counter8_3.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Counter8_3_EnableInt
export _Counter8_3_EnableInt
export  Counter8_3_DisableInt
export _Counter8_3_DisableInt
export  Counter8_3_Start
export _Counter8_3_Start
export  Counter8_3_Stop
export _Counter8_3_Stop
export  Counter8_3_WritePeriod
export _Counter8_3_WritePeriod
export  Counter8_3_WriteCompareValue
export _Counter8_3_WriteCompareValue
export  Counter8_3_bReadCompareValue
export _Counter8_3_bReadCompareValue
export  Counter8_3_bReadCounter
export _Counter8_3_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bCounter8_3_ReadCompareValue  ; deprecated
export _bCounter8_3_ReadCompareValue  ; deprecated
export  bCounter8_3_ReadCounter       ; deprecated
export _bCounter8_3_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_3_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_3_EnableInt:
_Counter8_3_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_3_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_3_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_3_DisableInt:
_Counter8_3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_3_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_3_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_3_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_3_WritePeriod:
_Counter8_3_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_3_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_3_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_3_WriteCompareValue:
_Counter8_3_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_3_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_3_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_3_bReadCompareValue:
_Counter8_3_bReadCompareValue:
 bCounter8_3_ReadCompareValue:                   ; this name deprecated
_bCounter8_3_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Counter8_3_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_3_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 Counter8_3_bReadCounter:
_Counter8_3_bReadCounter:
 bCounter8_3_ReadCounter:                        ; this name deprecated
_bCounter8_3_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[Counter8_3_COMPARE_REG]          ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[Counter8_3_CONTROL_REG]          ; Save CR0 (running or stopped state)
   push  A                                       ;
   Counter8_3_Stop_M                             ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[Counter8_3_INPUT_REG]            ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[Counter8_3_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[Counter8_3_COUNTER_REG]          ; DR2 <- DR0
   mov   A, reg[Counter8_3_COMPARE_REG]          ; Stash the Count on the stack
   ...
   mov   reg[Counter8_3_INPUT_REG], A            ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[Counter8_3_CONTROL_REG], A          ;     this function was first called
