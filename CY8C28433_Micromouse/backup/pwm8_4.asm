...
;  Global Symbols
;-----------------------------------------------
export  PWM8_4_EnableInt
export _PWM8_4_EnableInt
export  PWM8_4_DisableInt
export _PWM8_4_DisableInt
export  PWM8_4_Start
export _PWM8_4_Start
export  PWM8_4_Stop
export _PWM8_4_Stop
export  PWM8_4_WritePeriod
export _PWM8_4_WritePeriod
export  PWM8_4_WritePulseWidth
export _PWM8_4_WritePulseWidth
export  PWM8_4_bReadPulseWidth
export _PWM8_4_bReadPulseWidth
export  PWM8_4_bReadCounter
export _PWM8_4_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_4_ReadPulseWidth    ; deprecated
export _bPWM8_4_ReadPulseWidth    ; deprecated
export  bPWM8_4_ReadCounter       ; deprecated
export _bPWM8_4_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_4_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_4_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_4_WritePeriod
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_4_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_4_WritePulseWidth:
_PWM8_4_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_4_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_4_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_4_bReadPulseWidth:
_PWM8_4_bReadPulseWidth:
 bPWM8_4_ReadPulseWidth:                         ; this name deprecated
_bPWM8_4_ReadPulseWidth:                         ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_4_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_4_bReadCounter
;
;  DESCRIPTION:
...
;
 PWM8_4_bReadCounter:
_PWM8_4_bReadCounter:
 bPWM8_4_ReadCounter:                            ; this name deprecated
_bPWM8_4_ReadCounter:                            ; this name deprecated
   ...
   mov   A, reg[PWM8_4_COMPARE_REG]              ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_4_Stop_M                                 ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_4_INPUT_REG]                ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_4_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_4_COUNTER_REG]              ; DR2 <- DR0
   mov   A, reg[PWM8_4_COMPARE_REG]              ; Stash the Count on the stack
   ...
   mov   reg[PWM8_4_INPUT_REG], A                ;
   M8C_SetBank0                                  ;
   PWM8_4_Start_M                                ;   then re-enable the PWM.
