...
include "m8c.inc"
include "memory.inc"
include "Counter8_4.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Counter8_4_EnableInt
export _Counter8_4_EnableInt
export  Counter8_4_DisableInt
export _Counter8_4_DisableInt
export  Counter8_4_Start
export _Counter8_4_Start
export  Counter8_4_Stop
export _Counter8_4_Stop
export  Counter8_4_WritePeriod
export _Counter8_4_WritePeriod
export  Counter8_4_WriteCompareValue
export _Counter8_4_WriteCompareValue
export  Counter8_4_bReadCompareValue
export _Counter8_4_bReadCompareValue
export  Counter8_4_bReadCounter
export _Counter8_4_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bCounter8_4_ReadCompareValue  ; deprecated
export _bCounter8_4_ReadCompareValue  ; deprecated
export  bCounter8_4_ReadCounter       ; deprecated
export _bCounter8_4_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_4_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_4_EnableInt:
_Counter8_4_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_4_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_4_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_4_DisableInt:
_Counter8_4_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Counter8_4_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_4_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_4_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_4_WritePeriod:
_Counter8_4_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_4_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_4_WriteCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_4_WriteCompareValue:
_Counter8_4_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Counter8_4_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_4_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Counter8_4_bReadCompareValue:
_Counter8_4_bReadCompareValue:
 bCounter8_4_ReadCompareValue:                   ; this name deprecated
_bCounter8_4_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Counter8_4_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Counter8_4_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 Counter8_4_bReadCounter:
_Counter8_4_bReadCounter:
 bCounter8_4_ReadCounter:                        ; this name deprecated
_bCounter8_4_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[Counter8_4_COMPARE_REG]          ; Save the Compare register on the stack
   push  A                                       ;
   mov   A, reg[Counter8_4_CONTROL_REG]          ; Save CR0 (running or stopped state)
   push  A                                       ;
   Counter8_4_Stop_M                             ; Disable (stop) the Counter if running
   M8C_SetBank1                                  ;
   mov   A, reg[Counter8_4_INPUT_REG]            ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[Counter8_4_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[Counter8_4_COUNTER_REG]          ; DR2 <- DR0
   mov   A, reg[Counter8_4_COMPARE_REG]          ; Stash the Count on the stack
   ...
   mov   reg[Counter8_4_INPUT_REG], A            ;
   M8C_SetBank0                                  ;   then re-enable (start) the counter
   mov   A, [X+bOrigControlReg]                  ;     if it was running when
   mov   reg[Counter8_4_CONTROL_REG], A          ;     this function was first called
