...
include "m8c.inc"
include "PWM8_LeftRev.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWM8_LeftRev_EnableInt
export _PWM8_LeftRev_EnableInt
export  PWM8_LeftRev_DisableInt
export _PWM8_LeftRev_DisableInt
export  PWM8_LeftRev_Start
export _PWM8_LeftRev_Start
export  PWM8_LeftRev_Stop
export _PWM8_LeftRev_Stop
export  PWM8_LeftRev_WritePeriod
export _PWM8_LeftRev_WritePeriod
export  PWM8_LeftRev_WritePulseWidth
export _PWM8_LeftRev_WritePulseWidth
export  PWM8_LeftRev_bReadPulseWidth
export _PWM8_LeftRev_bReadPulseWidth
export  PWM8_LeftRev_bReadCounter
export _PWM8_LeftRev_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_LeftRev_ReadPulseWidth    ; deprecated
export _bPWM8_LeftRev_ReadPulseWidth    ; deprecated
export  bPWM8_LeftRev_ReadCounter       ; deprecated
export _bPWM8_LeftRev_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_LeftRev_EnableInt:
_PWM8_LeftRev_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_LeftRev_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_LeftRev_DisableInt:
_PWM8_LeftRev_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_LeftRev_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_Stop
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_LeftRev_WritePeriod:
_PWM8_LeftRev_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_LeftRev_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_LeftRev_WritePulseWidth:
_PWM8_LeftRev_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_LeftRev_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_LeftRev_bReadPulseWidth:
_PWM8_LeftRev_bReadPulseWidth:
 bPWM8_LeftRev_ReadPulseWidth:                   ; this name deprecated
_bPWM8_LeftRev_ReadPulseWidth:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_LeftRev_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_LeftRev_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_LeftRev_bReadCounter:
_PWM8_LeftRev_bReadCounter:
 bPWM8_LeftRev_ReadCounter:                      ; this name deprecated
_bPWM8_LeftRev_ReadCounter:                      ; this name deprecated
   ...
   mov   A, reg[PWM8_LeftRev_COMPARE_REG]        ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_LeftRev_Stop_M                           ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_LeftRev_INPUT_REG]          ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_LeftRev_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_LeftRev_COUNTER_REG]        ; DR2 <- DR0
   mov   A, reg[PWM8_LeftRev_COMPARE_REG]        ; Stash the Count on the stack
   ...
   mov   reg[PWM8_LeftRev_INPUT_REG], A          ;
   M8C_SetBank0                                  ;
   PWM8_LeftRev_Start_M                          ;   then re-enable the PWM.
